...
//                repository.delete(id, SecurityUtil.authUserId());
            ...
            case "filter":
                ...
                request.setAttribute("meals",
                        MealsUtil.getTos(mealRestController.get(dateFrom, dateTo, timeFrom, timeTo), MealsUtil.DEFAULT_CALORIES_PER_DAY));
            ...
            default:
                ...
                request.setAttribute("meals",
                        MealsUtil.getTos(mealRestController.get(), MealsUtil.DEFAULT_CALORIES_PER_DAY));
                request.getRequestDispatcher("/meals.jsp").forward(request, response);
                break;
        }
    }
