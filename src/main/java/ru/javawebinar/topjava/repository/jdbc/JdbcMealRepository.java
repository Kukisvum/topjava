...
public class JdbcMealRepository implements MealRepository {
    ...
    private final BeanPropertyRowMapper ROW_MAPPER = BeanPropertyRowMapper.newInstance(Meal.class);
    ...
    public List<Meal> getAll(int userId) {
        return jdbcTemplate.query(
                "SELECT * FROM meals WHERE user_id=?  ORDER BY datetime::date desc, datetime::time desc", ROW_MAPPER, userId);
    }
