...
public abstract class AbstractMealServiceTest extends AbstractServiceTest {
    ...
    @Test
    void create() {
        Meal created = service.create(getNew(Meal.class), USER_ID);
    ...
    @Test
    void update() {
        Meal updated = getUpdated(Meal.class);
        service.update(updated, USER_ID);
        MEAL_MATCHER.assertMatch(service.get(MEAL1_ID, USER_ID), getUpdated(Meal.class));
    }

    @Test
    void updateNotOwn() {
        NotFoundException exception = assertThrows(NotFoundException.class, () -> service.update(getUpdated(Meal.class), ADMIN_ID));
